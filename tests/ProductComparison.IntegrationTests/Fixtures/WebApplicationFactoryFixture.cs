...
public class WebApplicationFactoryFixture : WebApplicationFactory<Program>, IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        // Cria CSV temporário para testes (único por execução)
    ...
    public void ResetTestData()
    {
        ...
        else
        {
            ...
            var csvContent = @"Id,Name,Description,ImageUrl,Price,Rating,Brand,Color,Weight,Version
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        builder.ConfigureAppConfiguration((context, config) =>
        {
            ...
            config.AddInMemoryCollection(new Dictionary<string, string?>
            {
                ...
                ["Logging:LogLevel:Default"] = "Warning", // Menos logs durante testes
