...
public class CacheIntegrationTests : IntegrationTestBase
{
    ...
    {
        // Arrange - Popula cache da lista e verifica se produto ainda não existe
        ...
        // Garante que o produto de teste não existe ainda
        ...
        // Verifica que o produto foi criado e está na lista (prova que cache foi invalidado)
